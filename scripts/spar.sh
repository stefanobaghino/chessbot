...
# Do not edit this file while a match runs: bash reads scripts incrementally, and a shifted
# offset once re-ran the tail of the pipeline and truncated the log (see #50).
set -euo pipefail
